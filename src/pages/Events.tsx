...
const Events: React.FC = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      // ✅ SAFE MAPPING (NO EVENT WILL BE DROPPED)
      ...
      const mappedClubs: Club[] = clubsData.map((c: any) => ({
        _id: c.id,
        name: c.name,
      }))
  ...
  // ✅ FILTERS THAT NEVER HIDE VALID EVENTS
  const filteredEvents = events.filter(event => {
    ...
    const matchesClub =
      !selectedClub || event.clubId === selectedClub || event.clubId === ''
